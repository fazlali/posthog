...
describe('DestinationType API', () => {
    describe('GET destination types', () => {
        test('should be able to retrieve a list of destination types', async () => {
...
describe('Destination API', () => {
    describe('POST destination', () => {
        test('should be able to create a destination', async () => {
        ...
        test('should not be able to create a destination with an invalid config schema', async () => {
            const projectId = (await createProjectOk()).id
            const response = await postDestination(projectId, {
                name: 'Test Destination',
                description: 'Test Description',
    ...
    describe('GET destination', () => {
        test('should be able to retrieve a destination', async () => {
            const projectId = (await createProjectOk()).id
        ...
        test('should not be able to retrieve a destination from another project', async () => {
            const projectId = (await createProjectOk()).id
            const destination = await postDestinationOk(projectId, {
                name: 'Test Destination',
                description: 'Test Description',
    ...
    describe('PUT destination', () => {
        test('should be able to update a destination', async () => {
            const projectId = (await createProjectOk()).id
            const destination = await postDestinationOk(projectId, {
                name: 'Test Destination',
                description: 'Test Description',
        ...
        test('should not be able to update a destination with an invalid config schema', async () => {
            const projectId = (await createProjectOk()).id
            const destination = await postDestinationOk(projectId, {
                name: 'Test Destination',
                description: 'Test Description',
        ...
        test('should not be able to change the destination type', async () => {
        ...
        test('should not be able to update a destination with an invalid id', async () => {
            const projectId = (await createProjectOk()).id
        ...
        test('should not be able to update a destination from another project', async () => {
            const projectId = (await createProjectOk()).id
            const destination = await postDestinationOk(projectId, {
                name: 'Test Destination',
                description: 'Test Description',
    ...
    describe('DELETE destination', () => {
        test('should be able to delete a destination', async () => {
            const projectId = (await createProjectOk()).id
            const destination = await postDestinationOk(projectId, {
                name: 'Test Destination',
                description: 'Test Description',
        ...
        test('should not be able to delete a destination with an invalid id', async () => {
            const projectId = (await createProjectOk()).id
            const response = await deleteDestination(projectId, 'invalid')
            expect(response.status).toEqual(404)
        })

        test('should not be able to delete a destination from another project', async () => {
            const projectId = (await createProjectOk()).id
            const destination = await postDestinationOk(projectId, {
                name: 'Test Destination',
                description: 'Test Description',
...
const listDestinationTypes = async (): Promise<Response> => {
    return await fetch('http://localhost:3000/api/destinations/types')
}

const listDestinationTypesOk = async (): Promise<DestinationType[]> => {
    const response = await listDestinationTypes()
    if (!response.ok) {
